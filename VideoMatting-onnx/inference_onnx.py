...
def infer_rvm_frame(weight: str = "rvm_mobilenetv3_fp32.onnx",
    ...
    downsample_ratio = np.array([0.4], dtype=np.float32)  # 必须是 FP32
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default="../videos/TEST_02.mp4")
    parser.add_argument("--output", type=str, default="../output/TEST_02_py.mp4")
